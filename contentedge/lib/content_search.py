...
class ContentSearch:
    ...
    def search_index(self, index_search: IndexSearch) -> list:
        ...
        headers['Content-Type'] = 'application/vnd.asg-mobius-search.v1+json'
        headers['Accept'] = 'application/vnd.asg-mobius-search.v1+json'
        ...
        response = requests.post(search_url, json=index_search.to_dict(), headers=headers, verify=False)
